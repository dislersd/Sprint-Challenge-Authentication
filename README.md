...
1. What is the purpose of using _sessions_?
 - Sessions are commonly used to allow a server to store info about a client. They can help you persist data across requests.
***
1. What does bcrypt do to help us store passwords in a secure manner.
 - Hashes our passwords. Encodes your password and stores it as a crazy string of numbers and letters
***
1. What does bcrypt do to slow down attackers?
 - Makes it very hard to brute force hased passwords. It takes an enormous amount of time.
***
1. What are the three parts of the JSON Web Token?
  1. The Header - contains algorithm and token type
  2. The Payload - holds permissions and other data we want
  3. The Signature - Encodes the three parts of the token
***
## Project Set Up
